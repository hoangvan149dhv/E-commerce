...
DROP TABLE `devvn_xaphuongthitran` ;
...
DROP TABLE `tbl_brand_code_product` ;
...
DROP TABLE `tbl_category_product` ;
...
DROP TABLE `tbl_configmail_receiver` ;
