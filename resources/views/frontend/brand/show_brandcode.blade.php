        ...
        <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate mb-5 text-center">
                <p class="breadcrumbs mb-0"><span class="mr-2"><a href="{{ URL::to('/')}}">Trang chủ <i
                        class="fa fa-chevron-right"></i></a></span> <span>@foreach ($brand_name as $product){{$product->brandcode_name}}@endforeach<i
                        class="fa fa-chevron-right"></i></span></p>
                <h2 class="mb-0 bread">{{$product->brandcode_name}}</h2>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-md-12">
                ...
                <div class="row mt-5">
                    <div class="col text-center">
                        <div class="block-27">
                            <ul>
                                <li>{!! $productDataFromBrand->links() !!}</li>
                            </ul>
                        </div>
                    </div>
                </div>
