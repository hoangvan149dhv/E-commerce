                    ...
                    @foreach (Session::get('cart') as $cart)
                        <tr>
                            <td style="border: 1px solid #E6E4DF;padding:25px 10px;text-align: center;">
                                <img src="public/upload/{{ $cart['product_image'] }}" class="img-fluid" width="90"
                                     height="90" alt="">
                            </td>
                            ...
                            <td style="border: 1px solid #E6E4DF;" class="cart_quantity">
                                <form action="{{ URL::to('update_cart_quantity_ajax') }}" method="POST"
                                    ...
                                    <div class="cart_quantity_button" style="margin-top:10px;text-align: center;">
                                        ...
                                        <input class="cart_quantity_input" type="number" name="qty"
                                               value="{{ $cart['product_qty'] }}" width="50px" min="1">
                                        <input type="submit" name="submit" value="Sửa" class="cart_quantity_delete"
                                               style="color:white;font-size:17px;background:#FE980F;">
                                    </div>
                                </form>
                            </td>
                            ...
                            <td class="cart_deletee" style="border: 1px solid #E6E4DF;">
                                <a class="cart_quantity_delete" href="{{ URL::to('/deleteajax/'.$cart['product_id'])}}"><i
