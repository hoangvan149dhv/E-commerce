...
class loginController extends Controller
{
    ...
    public function get_pass(Request $request)
    {
        ...
        $result = DB::table('tbl_admin')->where('admin_email', $admin_email)->where('admin_question_getpass',
            $admin_question)->first();
        ...
        if ($result) {
            ...
            $template = "";
            $item_detail_order = DB::table('tbl_admin')->where('admin_email',
                $admin_email)->where('admin_question_getpass', $admin_question)->get();
